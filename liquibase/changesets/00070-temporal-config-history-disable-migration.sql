...
--changeset joachim:00070-temporal-config-history-disable-migration endDelimiter://

-- this script repeats part of 00068, but disables the migration functionality of the versioning script, as 00069 should have migrated everything already
DO
$$
  DECLARE
