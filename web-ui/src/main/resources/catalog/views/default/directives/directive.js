      ...
      return {
        ...
        link: function linkFn(scope, element, attrs) {
            ...
            return $http
              ...
              .then(function (response) {
                ...
                var editorSteps = [
                    ...
                    { from: "approved_private", to: "submitted_for_removed" },
                    { from: "approved_private", to: "submitted_for_retired" },
                  ...
                  reviewerSteps = editorSteps.concat([
                    ...
                    { from: "approved", to: "approved_private" },
                    { from: "approved_private", to: "removed" },
                    { from: "approved_private", to: "retired" },
                    { from: "approved_private", to: "approved" },
                    { from: "approved_for_published", to: "approved" },
                    { from: "approved_for_published", to: "approved_private" },
          ...
          scope.getStatusEffects = function (user) {
            ...
            return scope.statusEffects[
              user.isAdmin() ? "admin" : isReviewer ? "reviewer" : "editor"
            ];
          };
